export default function SchemeSummary({ state, title, summary, tags, slug, props }) {
    return (
        <button className="bg-white rounded-[8px] transition shadow-box7 duration-150 border-b-4 hover:border-primary border-transparent hover:shadow-box6 flex p-8 space-x-6" href="#">
