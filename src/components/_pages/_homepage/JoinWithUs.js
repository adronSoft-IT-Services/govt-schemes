        ...
        <div className="grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
          ...
          <div className=" bg-white shadow-box5 rounded-[8px] transition duration-100 hover:shadow-box3">
            <div className="course-thumb h-[297px] rounded-t-[8px]  relative">
              <Image width={355} height={270} src="/images/all-img/e1.png" alt="" className=" w-full h-full object-cover rounded-t-[8px]" />
            </div>
          ...
          <div className=" bg-white shadow-box5 rounded-[8px] transition duration-100 hover:shadow-box3">
            <div className="course-thumb h-[297px] rounded-t-[8px]  relative">
              <Image width={355} height={270} src="/images/all-img/e2.png" alt="" className=" w-full h-full object-cover rounded-t-[8px]" />
            </div>
            <div className="course-content p-8">
              <h4 className=" text-xl mb-5 font-bold">
                <Link href="/" className=" hover:text-primary transition duration-150">
          ...
          <div className=" bg-white shadow-box5 rounded-[8px] transition duration-100 hover:shadow-box3">
            <div className="course-thumb h-[297px] rounded-t-[8px]  relative">
              <Image width={355} height={270} src="/images/all-img/e3.png" alt="" className=" w-full h-full object-cover rounded-t-[8px]" />
            </div>
            <div className="course-content p-8">
              <h4 className=" text-xl mb-5 font-bold">
                <Link href="/" className=" hover:text-primary transition duration-150">
