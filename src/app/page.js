...
export default function Home() {
  return (
    <>
      <div className="openmobile-menu fixed top-0 h-screen pt-10 pb-6 bg-white shadow-box2 w-[320px] overflow-y-auto flex flex-col
          z-[999]">
        <div className="flex justify-between px-6 flex-none">
          <a href="/" className="brand-logo flex-none mr-10 ">
